...
/**
 * One-time OAuth consent flow for Google Sheets API.
 *
 * Usage:
 *   1. Save credentials to ~/.gsheets_credentials.json:
 *      { "client_id": "xxx.apps.googleusercontent.com", "client_secret": "xxx" }
 *   2. Run: node auth.js
 *   3. Browser opens -> consent -> tokens saved to ~/.gsheets_tokens.json
 */
