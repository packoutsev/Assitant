...
// POST /api/token — generate ephemeral token for OpenAI Realtime API
...
// POST /api/review — score a call transcript using chat completions
...
app.listen(PORT, () => {
  console.log(`Call Trainer API running on http://localhost:${PORT}`);
});
